...
import 'package:flutter_firebase/service/database2.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  TextEditingController _license_Controller = TextEditingController();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FormContainerWidget(
                  controller: _license_Controller,
                  hintText: "License No",
                  isPasswordField: false,
                ),
                SizedBox(
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    Map<String, dynamic> employeeInfoMap = {
                      ...
                      "License": _license_Controller.text,
  ...
  void _signUp() async {
    ...
    String license = _license_Controller.text;
